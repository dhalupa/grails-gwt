 ...
 */
public class DefaultActionHandlerGrailsClass extends AbstractInjectableGrailsClass implements ActionHandlerGrailsClass {
    public DefaultActionHandlerGrailsClass(Class wrappedClass) {
        super(wrappedClass, ActionHandlerArtefactHandler.TYPE);
    }
}
